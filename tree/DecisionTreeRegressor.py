...
class DecisionTreeRegressor:
    ...
    def node(self, dict_ : dict, data : numpy.array, depth_ : int, track : dict = None) -> None:
        ...
        if self.tools(call = 'chk_stp', depth = depth_): 
            return
        ...
        if(len(self.all_data.iloc[in_00, -1].unique()) == 1):
            ...
            self.node(dict_['inside'][0], data = in_00, depth_= depth_ + 1)
        ...
        if(len(self.all_data.iloc[in_01, -1].unique()) == 1):
            ...
            self.node(dict_['inside'][1], data = in_01, depth_= depth_ + 1)
    ...
    def parallel(self, data_) -> dict:
        ...
        for _2 in range(len(SSR_ftr)): 
            tmp.append(SSR_ftr[_2]['SSR'])
    ...
    def tools(self, call : str = None, **kwargs):
        ...
        def chk_stp(kwargs) -> bool:
            ...
            try: 
                ...
                pass
            if depth_ == self.stopping_criteria['depth']: 
                return True
            return False
        ...
        if call == None: 
            ...
            return chk_stp(kwargs)
        elif call == 'threshold': 
            return threshold(kwargs)
        elif call == 'split_SSR': 
            return split_SSR(self, kwargs)
